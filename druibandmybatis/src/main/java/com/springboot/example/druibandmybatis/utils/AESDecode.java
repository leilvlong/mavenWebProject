...
public class AESDecode {
    ...
    public static void main(String[] args) throws Exception {
        // 发送POST请求示例
        String ak_id1 = "LTAIbADMy997Tb1q"; //用户ak
        String ak_secret1 = " vryeRVTsPU4I82zWHcgEU3dpoC0lwz"; // 用户ak_secret
        String url = "https://shujuapi.aliyun.com/org_code/service_code/api_name";
        String body = "{\"type\": 0, \"image_url\":\"123.jpg\"}";
        sendPost(url, body, ak_id1, ak_secret1);

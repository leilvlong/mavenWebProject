package com.pingyougou.shopcontroller;
...
public class ItemCatController {
    ...
    @RequestMapping("/findByParrent/{parrentId}")
	public List<TbItemCat> findByParrent(@PathVariable(value = "parrentId")Long pparrentId){
		return itemCatService.findByParrent(pparrentId);
	}

...
@Component
@ConfigurationProperties("redis.lock.config")
public class RedisLock {
    ...
    public String getRequestId(String key) {
        try {
            RedisCallback<String> callback = (connection) -> {
                Jedis jedis = (Jedis) connection.getNativeConnection();
                return jedis.get(redisLockPrefix+"_"+ key);
            };
            String result = (String) redisTemplate.execute(callback);
            return result;
        } catch (Exception e) {
    ...
    public boolean releaseLock(String key,String requestId) {
        ...
        try {
            ...
            keys.add(redisLockPrefix+"_"+ key);
    ...
    public String getRedisLockPrefix() {
        return redisLockPrefix;
    }

    public void setRedisLockPrefix(String redisLockPrefix) {

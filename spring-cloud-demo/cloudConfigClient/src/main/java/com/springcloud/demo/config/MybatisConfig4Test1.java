...
@MapperScan(basePackages = "com.springcloud.demo", sqlSessionTemplateRef = "sqlSessionTemplate")
public class MybatisConfig4Test1 {

    // 配置数据源
    @Bean(name = "dataSource")
    public DataSource dataSource(DBConfig4Test1 config) throws SQLException {

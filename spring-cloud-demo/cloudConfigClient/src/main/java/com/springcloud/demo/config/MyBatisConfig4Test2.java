...
@MapperScan(basePackages = "com.springcloud.demo", sqlSessionTemplateRef = "sqlSessionTemplate2")
public class MyBatisConfig4Test2 {

    // 配置数据源
    @Primary
    @Bean(name = "dataSource2")
    public DataSource dataSource(DBConfig4Test2 config) throws SQLException {
